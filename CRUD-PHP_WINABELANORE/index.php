        ...
        <table class="table table-striped table-hover">
          ...
          ?>
            <tr>
              ...
              <td><a type = "submit" name = "edit" href = "" data-toggle="modal" data-target="#updateModal<?php echo $getData['id'] ?>"><i class='fa fa-edit' style='font-size:16px;color:blue'></i></a></td>
              <td><a type = "submit" name = "delete" href = "index.php?id_delete=<?php echo $getData['id'] ?>"><i class='fa fa-trash-o' style='font-size:16px;color:red'></i></a></td>
            </tr> 
